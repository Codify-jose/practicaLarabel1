...
<form>
  ...
  <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="escribirnombre">
  ...
  <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="telefono">
    ...
    <button type="button" class="btn btn-secondary">Crear categoria</button>
</div>
</form>
</body>
</html>